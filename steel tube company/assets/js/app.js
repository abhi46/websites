(function ($, window, document, undefined) {
	...
	if($.find('#counter')[0]) {
			$('#counter').countdown('2019/01/24 12:00:00').on('update.countdown', function(event) {
	...
	=============================================== */
		...
		jQuery("#preloader").delay(700).fadeOut(500); 
	...
	=============================================== */
		...
		function initialize() {
		var myLatlng = new google.maps.LatLng(26.964920, 75.7821800); // Change your location Latitude and Longitude 
		var mapOptions = {
		zoom: 15,
		center: myLatlng
		}
